  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="border-right" id="sidebar-wrapper" style="background-color: white;">
      ...
      <div class="list-group list-group-flush sticky-top">
        ...
        <a href="#" class="list-group-item list-group-item-action bg-light" style="border-left:4px solid grey;" data-toggle="modal" data-target="#staticBackdrop">Add Offers</a>
        <a href="#" class="list-group-item list-group-item-action bg-light" style="border-left:4px solid grey;" data-toggle="modal" data-target="#staticBackdrop">New Bookings</a>
        <a href="#" class="list-group-item list-group-item-action bg-light" style="border-left:4px solid grey;" data-toggle="modal" data-target="#staticBackdrop">History</a>
        <a href="#" class="list-group-item list-group-item-action bg-light" style="border-left:4px solid grey;" data-toggle="modal" data-target="#staticBackdrop">User Details</a>
        <a href="#" class="list-group-item list-group-item-action bg-light" style="border-left:4px solid grey;" data-toggle="modal" data-target="#staticBackdrop">Booked Dates</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
